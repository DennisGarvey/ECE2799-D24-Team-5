...
AnalogMenuItem menuOptionsSunscreenOptionsSPFLevel(&minfoOptionsSunscreenOptionsSPFLevel, 0, nullptr, INFO_LOCATION_PGM);
...
const PROGMEM AnalogMenuInfo minfoCurrentUVIndex = { "Current UV Index", 9, 17, 255, NO_CALLBACK, 0, 1, " UVI" };
